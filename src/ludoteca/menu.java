...
public class menu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lbl_empl = new javax.swing.JLabel();
        ...
        lbl_empleados.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/icono de empleados.png"))); // NOI18N
        lbl_empleados.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lbl_empleadosMouseClicked(evt);
            }
        });
        getContentPane().add(lbl_empleados, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 290, 150, -1));

        lbl_empl.setText("Empleados");
        getContentPane().add(lbl_empl, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 440, -1, -1));
        ...
        getContentPane().add(lbl_exit, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 380, 100, 100));

        lbl_salir.setText("Salir");
        getContentPane().add(lbl_salir, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 480, -1, -1));
    ...
    private void lbl_empleadosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_empleadosMouseClicked
        empleados empl = new empleados();
        empl.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_lbl_empleadosMouseClicked
    ...
    private javax.swing.JLabel lbl_empl;
